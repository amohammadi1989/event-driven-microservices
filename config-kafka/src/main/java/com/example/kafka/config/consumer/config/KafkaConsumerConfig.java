package com.example.kafka.config.consumer.config;
import com.example.config.services.KafkaConfigData;
import com.example.config.services.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig <K extends Serializable,V extends SpecificRecordBase> {
  ...
  public Map<String,Object> consumerConfigs(){
    ...
    System.out.println(kafkaConsumerConfigData.toString());
    return props;
  }
  @Bean
